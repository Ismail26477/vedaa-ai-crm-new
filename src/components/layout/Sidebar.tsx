        ...
        >
          {!collapsed && (
            <div className="flex items-center gap-2">
              <img src="/vedaa-ai-logo1.png" alt="Vedaa AI" className="w-38 h-46 object-contain" />
              <span className="text-xl font-bold text-white font-display"></span>
            </div>
          )}
          {collapsed && <img src="/vedaa-ai-logo2.png" alt="vedaa-ai-logo.png" className="w-70 h-74 object-contain" />}
        </div>
